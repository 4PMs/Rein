"""Canonical, secret-safe normalization of observed HTTP requests.

This module intentionally operates on HTTP after any TLS termination.  It does
not perform interception, enforcement, or tool identification.
"""
