...
def _with_timing_usage(result: BenchmarkResult, args: argparse.Namespace,
                       run_perf_start: float, started_at: datetime,
                       *, override_usage: dict | None = None) -> BenchmarkResult:
...
def _run_pipeline(args: argparse.Namespace) -> "RunStore":
    ...
    # (tempera.fixtures) must be resolved from it before anything below
            ...
            try:
                ...
                if config.agent_runtime == "container":
                    ...
                    topology = ForcedGatewayTopology(
                        ...
                        target=target.get("container", "tempera-juice-forced"),
                        target_image=target.get("image", "tempera-juice-shop:latest"),
                        attacker_image=(getattr(args, "attacker_image", None)
                                        or os.environ.get("TEMPERA_ATTACKER_IMAGE")
                                        or "tempera-attacker:kali"),
                    ...
                    try:
                        # No os.environ["TEMPERA_PROVIDER"/"TEMPERA_MODEL"]
                        ...
                        # container (default "tempera-juice-forced") is an
                        ...
                        # "http://tempera-juice:3000"). Without registering
                        # it as a runtime alias here, evaluate_run's
                        # normalize_targets() never rewrites
                        # "http://tempera-juice-forced:3000/..." event
