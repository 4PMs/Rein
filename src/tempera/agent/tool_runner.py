"""Container-local, argv-only tool launcher used for provenance capture."""
...
AGENT_COMMAND_PATH_ENV = "TEMPERA_AGENT_COMMAND_PATH"
DEFAULT_AGENT_COMMAND_PATH = "/opt/tempera/agent-bin"
...
def _preview(value: bytes | str) -> str:
    ...
    for secret in (os.environ.get("DEEPSEEK_API_KEY", ""), os.environ.get("TEMPERA_DB_OBSERVER_TOKEN", "")):
        if secret:
